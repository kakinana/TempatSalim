    ...
    <div class="w-full max-w-4xl">
        <body class="bg-gray-100 flex items-center justify-center min-h-screen">
            <div class="w-full max-w-4xl">
                ...
                <button type="button" onclick="window.location='{{ route('admin.addKategori') }}'" class="bg-yellow-400 hover:bg-yellow-500 text-black font-bold py-2 px-4 rounded mb-4">+ Add New Kategori</button>
                    ...
                    <tr>
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex justify-center space-x-2">
                                <!-- Edit Button -->
                                <button type="button"
                                    onclick="window.location='{{ route('admin.editKategori', $k->id) }}'"
                                    class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
                                    Ubah
                                </button>
                                <!-- Delete Button -->
                                <form action="{{ route('kategori.delete', $k->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this user?')">
                                    @csrf
                                    @method('DELETE')
